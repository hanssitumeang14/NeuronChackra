export default function InfoTxtCompatibility() {
  const baseCircleStyle =
    "w-10 h-10 rounded-full border border-[#00bcd4] text-white text-sm font-bold flex items-center justify-center bg-[#1f2937]";  // bg-black/40 diganti ke hex

  return (
    <div className="info-txt space-y-6 flex flex-col items-center justify-center text-white py-10 px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-[#1e1b3a] via-[#2a1a3b] to-[#14121f] border border-[#00bcd4] backdrop-blur-md rounded-2xl p-6 shadow-xl text-center">
          <h3 className="font-bold text-xl text-[#00bcd4] mb-2">Hubungan</h3>
        ...
        <div className="bg-gradient-to-br from-[#1e1b3a] via-[#2a1a3b] to-[#14121f] border border-[#00bcd4] backdrop-blur-md rounded-2xl p-6 shadow-xl text-center">
          <h3 className="font-bold text-xl text-[#00bcd4] mb-2">Kebersatuan</h3>
        ...
        <div className="bg-gradient-to-br from-[#1e1b3a] via-[#2a1a3b] to-[#14121f] border border-[#00bcd4] backdrop-blur-md rounded-2xl p-6 shadow-xl text-center">
          <h3 className="font-bold text-xl text-[#00bcd4] mb-2">Keharmonisan</h3>
